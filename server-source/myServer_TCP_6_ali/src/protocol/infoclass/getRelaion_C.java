...
public class getRelaion_C extends HaveToHave{
	...
	/**
	 * 0-不带任何附加选项
	 * 1-基于RelationID查询关联的SearchUserID与Activity
	 *   此时RelationId不为0,其他两项为0
	 * 2-基于ActivityID查询关联的SearchUserID中的详细信息
	 *   此时ActivityID不为0,其他两项为0
	 * 3-基于SearchUserID查询关联ActivityID中的详细信息
	 *   此时SearchUserID不为0,其他两项为0
	 * 4-基于SearchUserID+Activity查询其关系
	 */
