...
public class getActivityDiscussList_C extends HaveToHave{

	private int p = h_protocolfromclient1.getActivityDiscussList_C;
	...
	public String toString() {
		return "getActivityDiscussList_C [p=" + p + ", ActivityID="
